...
Vendored verbatim from the official Dr. GRPO repo
(https://github.com/sail-sg/understand-r1-zero,
understand_r1_zero/math_grader.py) so this repo is self-contained for the
`math_drgrpo` reward (see verl/utils/reward_score/__init__.py). Requires
sympy, math_verify, pylatexenc, latex2sympy2_extended (in requirements).
"""
